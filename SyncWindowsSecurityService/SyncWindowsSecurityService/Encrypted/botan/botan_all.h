...
* 'configure.py --minimized-build --amalgamation --cpu=x86 --enable-modules=md5 --enable-modules=aes'
*
* Target
...
#define BOTAN_VERSION_DATESTAMP 20170807

#define BOTAN_VERSION_RELEASE_TYPE "released"

#define BOTAN_VERSION_VC_REVISION "git:33f87a596ffa1fcbc017d9593dce0906d7d32208"
